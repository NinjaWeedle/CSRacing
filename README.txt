...
CALCULATOR STREET RACING DX

A drag racing game written by Oxiti8 in pure TI-BASIC for the TI-84 Plus C Silver Edition and TI-84 Plus CE.

The ultimate TI-BASIC drag racing game, now in color! Collect, Race and Upgrade 30 different cars, or create your own car from the ground up and share it with the world. 
...
I. GETTING STARTED
 1: How to install Calculator Street Racing DX on your TI-84+
 2: How to play
 3: Game modes
 4: CSR Garage
...
Send CSRACING.8xp to Archive or RAM, and CSRGARAG.8xp to RAM.
...
Game created by Oxiti8 in 2021-2022.
